...
Import this file into your Minecraft Alpha 1.1.2_01 or similar version project, and set up the Model(Entityname), Render(Entityname), and Entity(entityname). I have only tested this using "AlphaMCP2" for decompilation.
